...
- I'm still seeing two chars of padding on the sides of the terminal pane.
- Claude code has weird formatting. It shows the old input box graphic above the final result. I assume this is caused by the way claude code runs in the terminal and not in a typical, full-screen TUI.
